...
class ms2BundleMgrGroupUpdateManagerController extends ms2BundleManagerController
{
    ...
    public function process(array $scriptProperties = array()) {
        ...
        //Check for record
        $this->object = $this->modx->getObject('ms2bundleGroup', array('id' => $scriptProperties['id']));
        if ($this->object==null) {
    ...
    {
        $this->addJavascript($this->ms2Bundle->config['jsUrl'] . 'mgr/widgets/ingredients.grid.js');
    }
}